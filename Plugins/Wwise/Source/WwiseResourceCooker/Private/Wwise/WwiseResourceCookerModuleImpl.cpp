                                                                              ...
                                                                              const FWwiseSharedPlatformId& InPlatform, EWwiseExportDebugNameRule InExportDebugNameRule)
{
	...
	if (UNLIKELY(!DefaultResourceLoader))
	{
		UE_LOG(LogWwiseResourceCooker, Warning, TEXT("CreateCookerForPlatform: No ResourceLoaderImpl available creating platform %s"),
			*InPlatform.GetPlatformName().ToString());
		return nullptr;
	}
	...
	{
		UE_LOG(LogWwiseResourceCooker, Error, TEXT("CreateCookerForPlatform: Could not instantiate ResourceLoaderImpl creating platform %s"),
			*InPlatform.GetPlatformName().ToString());
		return nullptr;
	}
	...
	{
		UE_LOG(LogWwiseResourceCooker, Error, TEXT("CreateCookerForPlatform: Could not instantiate ResourceLoader creating platform %s"),
			*InPlatform.GetPlatformName().ToString());
	...
	{
		UE_LOG(LogWwiseResourceCooker, Error, TEXT("CreateCookerForPlatform: Could not instantiate ProjectDatabase creating platform %s"),
			*InPlatform.GetPlatformName().ToString());
	...
	{
		UE_LOG(LogWwiseResourceCooker, Error, TEXT("CreateCookerForPlatform: Could not instantiate ResourceCooker creating platform %s"),
			*InPlatform.GetPlatformName().ToString());
