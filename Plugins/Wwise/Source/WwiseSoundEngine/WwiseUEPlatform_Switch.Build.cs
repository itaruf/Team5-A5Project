...
public class WwiseUEPlatform_Switch : WwiseUEPlatform
{
	public WwiseUEPlatform_Switch(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
