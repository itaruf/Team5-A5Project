...
#include "Wwise/WwiseSoundEngineModule_2022_1.h"
...
IMPLEMENT_MODULE(FWwiseSoundEngineModule_2022_1, WwiseSoundEngine_2022_1)

IWwiseCommAPI* FWwiseSoundEngineModule_2022_1::GetComm()
{
	return new FWwiseCommAPI_2022_1;
}

IWwiseMemoryMgrAPI* FWwiseSoundEngineModule_2022_1::GetMemoryMgr()
{
	return new FWwiseMemoryMgrAPI_2022_1;
}

IWwiseMonitorAPI* FWwiseSoundEngineModule_2022_1::GetMonitor()
{
	return new FWwiseMonitorAPI_2022_1;
}

IWwiseMusicEngineAPI* FWwiseSoundEngineModule_2022_1::GetMusicEngine()
{
	return new FWwiseMusicEngineAPI_2022_1;
}

IWwiseSoundEngineAPI* FWwiseSoundEngineModule_2022_1::GetSoundEngine()
{
	return new FWwiseSoundEngineAPI_2022_1;
}

IWwiseSpatialAudioAPI* FWwiseSoundEngineModule_2022_1::GetSpatialAudio()
{
	return new FWwiseSpatialAudioAPI_2022_1;
}

IWwiseStreamMgrAPI* FWwiseSoundEngineModule_2022_1::GetStreamMgr()
{
	return new FWwiseStreamMgrAPI_2022_1;
}

IWwisePlatformAPI* FWwiseSoundEngineModule_2022_1::GetPlatform()
{
	return new FWwisePlatformAPI;
}

IWAAPI* FWwiseSoundEngineModule_2022_1::GetWAAPI()
{
#if AK_SUPPORT_WAAPI
...
void FWwiseSoundEngineModule_2022_1::SetDeleter(FDeleter&& InDeleter)
{
	Deleter = MoveTemp(InDeleter);
}

void FWwiseSoundEngineModule_2022_1::ShutdownModule()
{
	if (Deleter)
	{
		Deleter();
