...
public class WwiseUEPlatform_HoloLens : WwiseUEPlatform
{
	public WwiseUEPlatform_HoloLens(ReadOnlyTargetRules in_TargetRules, string in_ThirdPartyFolder) : base(in_TargetRules, in_ThirdPartyFolder) {}
