...
class WWISESOUNDENGINE_2022_1_API FWwiseSoundEngineModule_2022_1 : public IWwiseSoundEngineVersionModule
{
public:
	...
	virtual void SetDeleter(FDeleter&& InDeleter) override;
